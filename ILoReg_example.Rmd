...
cowplot::plot_grid(plotlist = lapply(top10$gene,function(x) GeneScatterPlot(iloreg_object,x,dim.reduction.type = "umap",return.plot = T)))
```


```{r Fig2, echo=TRUE, fig.height=20, fig.width=25}
VlnPlot(iloreg_object,clustering.type = "optimal",genes = top10$gene)
```
