...
```{r}
data <- Seurat::LogNormalize(Seurat::Read10X("~/../Downloads/pbmc3k/filtered_gene_bc_matrices_GRCh37.p13/hg19/"),verbose = FALSE)
```
...
tictoc::tic()
iloreg_object <- RunParallelICP(iloreg_object,threads = 12,L = 200,k = 15,C = 0.3,r = 5,d = 0.3,type = "L1",seed = 1)
tictoc::toc()
