---
title: "ILoReg example: peripheral blood mononuclear cells"
...
output: 
  BiocStyle::html_document:
    toc: true
vignette: >
  %\VignetteIndexEntry{ILoReg example: peripheral blood mononuclear cells}
...
![*Figure: Analysis workflows of `ILoReg` and a feature-selection based approach.*](../vignettes/figure.png){width=100%}
...
If you have questions related to `ILoReg`, please contact us in [GitHub](https://github.com/elolab/ILoReg/issues). 
