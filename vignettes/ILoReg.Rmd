...
```{r}
gene_markers_IGLL5_positive_b_cell_VS_negative <- FindGeneMarkers(iloreg_object,
...
gene_markers_TCL1A_positive_b_cell_VS_negative <- FindGeneMarkers(iloreg_object,
