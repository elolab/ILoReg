...
```{r}
sce <- readRDS(sce,file = "~/pbmc3k_iloreg.rds")
```
...
```{r Fig0, echo=TRUE, fig.height=10, fig.width=12, out.width = '100%'}
...
```{r FigTop1Scatter, echo=TRUE, fig.height=16, fig.width=20, out.width = '100%'}
GeneScatterPlot(sce,genes = unique(top1$gene),dim.reduction.type = "tsne",point.size = 0.7)
```


```{r FigTop1Scatter2, echo=TRUE, fig.height=16, fig.width=20, out.width = '100%'}
...
```{r FigHM, echo=TRUE, fig.height=15, fig.width=15, out.width = '100%'}
...
```{r, fig.height=5, fig.width=7, out.width = '100%',fig.align = "center"}
sce <- CalculateSilhouetteInformation(sce,K.range = 2:50)
...
```{r FigRenaming, echo=TRUE, fig.height=10, fig.width=12, out.width = '100%'}
sce <- SelectKClusters(sce,K=20)
...
```{r FigRenaming2, echo=TRUE, fig.height=10, fig.width=12, out.width = '100%'}
sce <- SelectKClusters(sce,K=20)
tsne_before <- ClusteringScatterPlot(sce,dim.reduction.type = "tsne",title = "Before renaming",show.legend = FALSE,return.plot = TRUE)
umap_before <- ClusteringScatterPlot(sce,dim.reduction.type = "umap",title = "Before renaming",show.legend = FALSE,return.plot = TRUE)
...
```{r FigAnnotation, echo=TRUE, fig.height=5, fig.width=6, out.width = '100%',fig.align = "center"}
...
GeneDropoutRatePlot(sce,genes = c("IGLL5","CD79A","TCL1A","VPREB3"),return.plot = F,use.clusters = c(17,13,12,2))
```
