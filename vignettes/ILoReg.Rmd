...
```{r, fig.height=4, fig.width=9, out.width = '70%',fig.align = "center"}
...
```{r FigAnnotation, echo=TRUE, fig.height=5, fig.width=6, out.width = '50%',fig.align = "center"}
...
```{r, echo=TRUE, fig.height=6, fig.width=8, out.width = '70%',fig.align = "center"}
# Select a clustering with K=20 clusters
iloreg_object <- SelectKClusters(iloreg_object,K=20)
