...
Please follow this [link](https://github.com/elolab/iloreg/examples) to an example, in which a peripheral blood mononuclear cell (PBMC) dataset was analyzed using `ILoReg`.
